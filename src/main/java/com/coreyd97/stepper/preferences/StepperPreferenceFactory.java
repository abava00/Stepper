...
public class StepperPreferenceFactory extends PreferenceFactory {
    ...
    protected void registerSettings() {
        ...
        prefs.registerSetting(Globals.ADD_ENABLE_SE_ALERT, Boolean.class, true, Preferences.Visibility.GLOBAL);
        prefs.registerSetting(Globals.ADD_ENABLE_NU_ALERT, Boolean.class, true, Preferences.Visibility.GLOBAL);
